...
public class AirportTransferPage2 {
    private WebDriver driver;
    private WebDriverWait wait;

    // Locators for the "Đến sân bay" flow
    private final By airportTransferTab = By.xpath("//*[@id=\"tab-journey-tab\"]/div/div[1]");
    private final By toAirportTab = By.xpath("//button[@label='Đến sân bay']");
    private final By pickupAirportField = By.xpath("//*[@id=\"journey-destination-search-input\"]");
    private final By pickupAirportSuggestion = By.xpath("//*[@id=\"autocompleteSearch\"]/div/div/ul/li[1]/button");
    private final By destinationField = By.xpath("//*[@id=\"journey-pickup-search-input\"]");
    private final By destinationSuggestion = By.xpath("//*[@id=\"autocompleteSearch\"]/div/div/ul/li[1]/button");
    ...
    // Constructor
    public AirportTransferPage2(WebDriver driver, WebDriverWait wait) {
        this.driver = driver;
        this.wait = wait;
    }
    ...
    // Click on the "Đến sân bay" tab
    public void clickToAirportTab() throws InterruptedException {
        System.out.println("Hành động: Nhấp vào tab 'Đến sân bay'");
        wait.until(ExpectedConditions.elementToBeClickable(toAirportTab)).click();
